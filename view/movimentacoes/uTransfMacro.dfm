inherited frmTransfMacro: TfrmTransfMacro
  Caption = 'Transfere Histologia para Macroscopia'
  ClientHeight = 224
  ClientWidth = 424
  ExplicitWidth = 430
  ExplicitHeight = 256
  ...
  object edHistologia: TMaskEdit [3]
    Left = 8
    Top = 24
    Width = 81
    Height = 21
    ...
    TabOrder = 0
    Text = '          '
    OnKeyPress = edHistologiaKeyPress
  end
