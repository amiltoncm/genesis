inherited frmPreencheCito: TfrmPreencheCito
  ...
  object pnDiagnostico: TPanel [4]
    ...
    object pnDiag1: TPanel
      ...
      object cbNegativo: TCheckBox
        Left = 8
        Top = 61
        Width = 314
        Height = 17
        CustomHint = BalloonHint1
        Caption = 'negativo para les'#227'o intraepitelial e malignidade'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clMaroon
        Font.Height = -13
        Font.Name = 'MS Sans Serif'
  ...
  object cbPadrao: TwwDBLookupCombo [6]
    Left = 737
    Top = 38
    Width = 172
    Height = 21
    ...
    Selected.Strings = (
      'lpm_descricao'#9'25'#9'Descri'#231#227'o'#9#9
      'lpm_codigo'#9'10'#9'C'#243'digo'#9#9)
