...
begin
  FiltrarBancos('ban_descricao', 'LIKE', '%' + cbProcura.Text + '%', 'ban_descricao', '0');
end;
...
begin
  Try
    ...
    begin
      FiltrarBancos('ban_descricao', '=', dsProcura.DataSet.FieldByName('ban_descricao').Text, 'ban_descricao', '0');
