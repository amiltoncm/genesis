...
begin
  FiltrarFuncoes('fnc_descricao', 'LIKE', '%' + cbProcura.Text + '%', 'fnc_descricao', '0');
end;

procedure TfrmProcFuncoes.Selecionar;
begin
  Try
    if Not(dsProcura.DataSet.FieldByName('fnc_descricao').IsNull) then
    begin
      FiltrarFuncoes('fnc_descricao', '=', dsProcura.DataSet.FieldByName('fnc_descricao').Text, 'fnc_descricao', '0');
