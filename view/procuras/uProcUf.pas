...
uses uDaoUf, dataCadastros, dataLookups, uCadUf;

procedure TfrmProcUf.Limpar;
begin
  ListarUf('uf_estado', '0');
end;
...
begin
  FiltrarUf('uf_estado', 'LIKE', '%' + cbProcura.Text + '%', 'uf_estado', '0');
end;
...
begin
  Try
    ...
    begin
      FiltrarUf('uf_estado', '=', dsProcura.DataSet.FieldByName('uf_estado').Text, 'uf_estado', '0');
