inherited frmRelExPac: TfrmRelExPac
  Caption = 'Relat'#243'rio Exames X Pacientes'
  ClientHeight = 132
  ExplicitWidth = 369
  ExplicitHeight = 157
  PixelsPerInch = 96
  ...
  object cbPaciente: TwwDBLookupCombo [8]
    Left = 104
    Top = 47
    Width = 251
    Height = 21
  ...
  inherited Relatorio: TppReport
    PrinterSetup.DocumentName = 'Relat'#243'rio Exames X Pacientes'
