...
type
  TfrmRelCitoEspecial = class(TfrmTmpRelFormNormal)
...
var
  frmRelCitoEspecial: TfrmRelCitoEspecial;
...
procedure TfrmRelCitoEspecial.FormActivate(Sender: TObject);
Var
vNomeRel: String;
begin
  inherited;
  ...
  Self.Caption := 'Cito especial: ' + vNomeRel;
end;
