inherited frmTmpConsultasNormal: TfrmTmpConsultasNormal
  Caption = 'frmTmpConsultasNormal'
  ClientHeight = 423
  ClientWidth = 868
  ExplicitWidth = 874
  ExplicitHeight = 448
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object lbParametro: TLabel [0]
    Left = 8
    Top = 8
    Width = 108
    Height = 13
    CustomHint = BalloonHint1
    Caption = 'Parametro da consulta'
  end
  ...
  object edParametro: TEdit [4]
    Left = 8
    Top = 24
    Width = 227
    Height = 21
    Hint = 'Digite o parametro da consulta'
    CustomHint = BalloonHint1
    ParentShowHint = False
    ShowHint = False
    TabOrder = 0
